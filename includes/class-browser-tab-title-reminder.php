...
class Browser_Tab_Title_Reminder {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Browser_Tab_Title_Reminder_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'BROWSER_TAB_TITLE_REMINDER_VERSION' ) ) {
			$this->version = BROWSER_TAB_TITLE_REMINDER_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	 ...
	 *
	 * @since     1.0.0
	 * @return    Browser_Tab_Title_Reminder_Loader    Orchestrates the hooks of the plugin.
	 */
